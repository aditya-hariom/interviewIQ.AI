...
function Step2Interview({ interviewData, onFinish }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-[1400px] min-h-[80vh] bg-white 
     ...
     overflow-hidden"
      ...
      p-6 space-y-6 border-r border-gray-200"
        >
          ...
          {/* timer area */}
          <div
            className="w-full max-w-md bg-white border-gray-200
      rounded-2xl shadow-md p-6 space-y-5"
        ...
        border border-gray-200 shadow-sm"
          ...
          <textarea
            ...
            resize-none outline-none border border-gray-200 focus:ring-2 
