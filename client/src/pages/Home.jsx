    ...
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col">
      ...
      <div className="flex-1 px- py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-28">
            ...
            >
              ...
              <span className="relative inline-block">
                <span
                  className="bg-green-100 text-green-600 px-6 py-0.5
                rounded-full"
                >
                  AI Intelligence
                </span>
          ...
          <div
            className="flex flex-col md:flex-col md:flex-row justify-center
        items-center gap-10 mb-28"
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Project-specific questions based on uploaded images",
                },
                {
                  image: pdfImg,
                  icon: <BsFileEarmarkText size={20} />,
          ...
          <div className="mb-32">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all"
                >
                  <div className="flex items-center justifiy-between gap-6">
                    <div className="w-1/2">
