...
function Auth({ isModel = false }) {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      // Don't log if user simply closed the popup
  ...
  return (
    <div
      className={`
      w-full 
      ${isModel ? "py4" : "min-h-screen bg-[#f3f3f3] flex items-center justify-center px-6 py-20"}
    `}
    >
      <motion.div
        ...
        bg-white shadow-2xl border vorder-gray-200`}
      >
